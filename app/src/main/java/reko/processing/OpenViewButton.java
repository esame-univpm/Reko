...
public class OpenViewButton extends MainButton {
    ...
    OpenViewButton(ViewsProcessing viewsProcessing, int positionX, int positionY, String imageButton, int[] colorRGB){
        ...
        diameterBackAnimation = viewsProcessing.height;  //diameter of the ellipse during backward animation
    ...
    public void animation() {
        ...
        if(flagPressed){
            drawEllipse(viewsProcessing, viewsProcessing.width/2, viewsProcessing.height, colorRGB, diameterAnimation);
            if(diameterAnimation/2<viewsProcessing.height/2){
    ...
    public void backAnimation(){
        ...
        viewsProcessing.ellipse(viewsProcessing.width/2, viewsProcessing.height, diameterBackAnimation, diameterBackAnimation);
        diameterBackAnimation-=250;
        if(diameterBackAnimation<150){
            diameterBackAnimation = viewsProcessing.height; //re-set diameterBackAnimation to initial value
